...
it('uses the minimum capacity', () => {
  ...
  // The minimum is a fixed design constant. It must not track the host's Buffer.poolSize,
  // which changed between Node versions and does not exist in a browser.
