/**
 * The smallest capacity that this module requests. The value keeps the allocation behavior of
 * the original node implementation, which used the 8 KiB `Buffer.poolSize` default of the Node
 * versions it targeted. Newer Node versions use a larger pool default; this constant does not
 * track it.
 */
