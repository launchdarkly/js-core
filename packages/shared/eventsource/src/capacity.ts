/**
 * The smallest capacity that this module requests.
 *
 * @remark
 * The value keeps the allocation behavior of the original node implementation, which used the 8 KiB
 * `Buffer.poolSize` default of the Node versions it targeted.
 */
