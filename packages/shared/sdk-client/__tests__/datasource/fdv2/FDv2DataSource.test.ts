...
describe('FDv2DataSource - initialization phase', () => {
...
describe('FDv2DataSource - synchronization phase', () => {
  ...
  it('continues on interrupted results', async () => {
    const dataCallback = jest.fn();
    const statusManager = makeStatusManager();
    const payload = makePayload({ state: 'selector' });
  ...
  it('continues on goodbye results', async () => {
    const dataCallback = jest.fn();
    const statusManager = makeStatusManager();
    const payload = makePayload({ state: 'selector' });
...
describe('FDv2DataSource - fdv1 fallback', () => {
  it('triggers fdv1 fallback when changeSet has fdv1Fallback flag', async () => {
    const dataCallback = jest.fn();
    const statusManager = makeStatusManager();
...
describe('FDv2DataSource - empty configurations', () => {
  it('resolves immediately with no initializers and no synchronizers', async () => {
    const dataCallback = jest.fn();
    const statusManager = makeStatusManager();
  ...
  it('resolves with initializer data even when no synchronizers exist (one-shot)', async () => {
    const dataCallback = jest.fn();
    const statusManager = makeStatusManager();
    const payload = makePayload({ state: 'selector' });
