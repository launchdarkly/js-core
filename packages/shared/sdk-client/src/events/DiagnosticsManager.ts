...
// TODO: refactor this to work with sdk-client. Especially localStorage in
// place of PersistentStorage.
...
export default class DiagnosticsManager {
  ...
  createInitEvent(): DiagnosticInitEvent {
    ...
    return {
      ...
      sdk: sdkData,
      configuration: {
        customBaseURI: this.config.serviceEndpoints.polling !== DEFAULT_BASE_URI,
        customStreamURI: this.config.serviceEndpoints.streaming !== DEFAULT_STREAM_URI,
        customEventsURI: this.config.serviceEndpoints.events !== DEFAULT_EVENTS_URI,
