...
## [0.7.1](https://github.com/launchdarkly/js-core/compare/server-sdk-ai-v0.7.0...server-sdk-ai-v0.7.1) (2024-12-19)
...
* The following workspace dependencies were updated
  * devDependencies
    * @launchdarkly/js-server-sdk-common bumped from 2.10.0 to 2.10.1
  * peerDependencies
    * @launchdarkly/js-server-sdk-common bumped from 2.x to 2.10.1
