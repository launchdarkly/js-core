...
Refer to the [SDK documentation](https://launchdarkly.com/docs/sdk/client-side/electron#getting-started) for instructions on getting started with using the SDK.
