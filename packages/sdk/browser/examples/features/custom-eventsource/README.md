...
only an application that imports this path pays for it. `@launchdarkly/eventsource` is an
optional dependency of the SDK. If your install omits optional dependencies (for example
`npm install --omit=optional`), install it directly before you import this entry point.
