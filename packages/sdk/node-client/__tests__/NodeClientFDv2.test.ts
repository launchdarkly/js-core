...
// Tracks the mode held by the mock FDv2 data manager. Seeded from
// opts.foregroundMode when createFDv2DataManagerBase is called, then updated
// on each setConnectionMode call -- mirrors the real manager's behavior.
