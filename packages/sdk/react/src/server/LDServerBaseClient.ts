...
/**
 * A minimal structural interface that any LaunchDarkly server SDK satisfies.
 *
 * @remarks
 ...
 *
 * The `LDClient` from `@launchdarkly/js-server-sdk-common` (and compatible edge SDKs)
 * structurally satisfies this interface — no explicit `implements` declaration is needed.
 */
