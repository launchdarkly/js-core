...
const offBaseFlag = {
  key: 'feature0', version: 1, on: false, fallthrough: { variation: 1 }, variations: [
    'zero',
    'one',
    'two',
  ]
...
const noQueries: Queries = {
  getFlag: function (key: string): Promise<Flag | null> {
    throw new Error('Function not implemented.');
  },
  getSegment: function (key: string): Promise<Segment | null> {
    throw new Error('Function not implemented.');
  },
  getBigSegmentsMembership: function (userKey: string): Promise<BigSegmentStoreMembership | null> {
    throw new Error('Function not implemented.');
  }
};
...
const targetBaseFlag = {
  key: 'feature0', version: 1, on: true, fallthrough: { variation: 1 }, variations: [
    'zero',
    'one',
    'two',
  ]
