...
import { FALSE_VARIATION_INDEX, TRUE_VARIATION_INDEX, variationForBoolean } from './test_data/booleanVariation';
 ...
 */
  ...
  addRule(flagRuleBuilder: TestDataRuleBuilder) {
    ...
    this.data.rules.push(flagRuleBuilder as TestDataRuleBuilder);
  }
  ...
  build(version: number) {
    ...
    if (this.data.rules) {
      baseFlagObject.rules = this.data.rules.map((rule, i) => (rule as TestDataRuleBuilder).build(String(i)));
    }
